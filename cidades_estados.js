// After selecting the state, the "buscaCidades" function inserts values ​​in the select cities in your blade.php files
...
function buscaCidades(e) {
    ...
    // aqui pega o index do Estado dentro do JSON
    ...
    if (j_index != -1) {
        ...
        json_cidades.estados[j_index].cidades.forEach(function (city) {
            var cid_opts = document.createElement('option');
            cid_opts.setAttribute('value', city)
            cid_opts.innerHTML = city;
